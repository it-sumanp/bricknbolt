...
public class OrderResourceIntTest {
    ...
    public void setup() {
        ...
        final OrderResource orderResource = new OrderResource(orderRepository, boltUserRepository, productRepository);
    ...
    public void createOrder() throws Exception {
        ...
        assertThat(testOrder.getMedium()).isEqualTo(DEFAULT_MEDIUM);
    }
    ...
    public void updateOrder() throws Exception {
        ...
        assertThat(testOrder.getMedium()).isEqualTo(UPDATED_MEDIUM);
    }
